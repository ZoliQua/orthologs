...
list_goids = ["go-0006412"]

for str_goid in list_goids:

	#str_goid = "go-0008361"
	log_filename1 = dir_log + "10together_pvalues_" + str_goid + "_general_" + current_time_abbrev + ".tsv"
	log_filename2 = dir_log + "10together_pvalues_" + str_goid + "_detailed_" + current_time_abbrev + ".tsv"
